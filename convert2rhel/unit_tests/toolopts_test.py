...
def test__log_command_used(caplog, monkeypatch):
    ...
    input_command = mock_cli_arguments(["--username", "uname", "--password", "123", "--activationkey", "456", "--token", "789"])
    expected_command = mock_cli_arguments(["--username", "uname", "--password", obfuscation_string, "--activationkey", obfuscation_string, "--token", obfuscation_string])
